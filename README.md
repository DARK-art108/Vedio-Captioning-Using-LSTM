...
Clone the repository : <code>git clone https://github.com/DARK-art108/Video-Captioning-Using-LSTM.git</code>

Video Caption Generator: <code>cd Video-Captioning-Using-LSTM</code>
